...
class arInnesPluginConfiguration extends sfPluginConfiguration
{
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arInnesPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arInnesPlugin/css/main.css', 'last', array('media' => 'all'));
      $context->response->addStylesheet('/plugins/arInnesPlugin/slick/slick.css', 'last', array('media' => 'all'));
    }
  }
